...
void Camera::Capture()
{
    ...
    {
        thread CameraCapture_Thread (&Camera::captureThread,this,ref(Camera)); 
...
// 多线程摄像头图像获取
void Camera::captureThread(VideoCapture &Camera)
{
    Mat ImgCapture;
    while(true)
    {
