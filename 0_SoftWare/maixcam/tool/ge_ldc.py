...
image_size = None
images_count = 0
min_images = 2  # 最少需要采集的图像数
img_file_path = "C:/Users/18750/Desktop/25-NUEDC-C/0_SoftWare/maixcam/tool/"  # 已经采集的图像路径
img_file_format = ".png"  # 已经采集的图像文件格式
