...
pip install -r 1_SoftWare_example\requirements.txt
```
...
```powershell
python 1_SoftWare_example\src\pc_opencv_experiment.py --input 1_SoftWare_example\data\input --output 1_SoftWare_example\data\output
```

## Capture from USB camera

```powershell
python 1_SoftWare_example\src\pc_opencv_experiment.py --camera 0 --capture 1_SoftWare_example\data\input\usb_capture.jpg
```

Then process the captured image:

```powershell
python 1_SoftWare_example\src\pc_opencv_experiment.py --input 1_SoftWare_example\data\input\usb_capture.jpg --output 1_SoftWare_example\data\output
```
